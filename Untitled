		...
		<form action="" method="post">
			...
			<fieldset class="row row-search">
				...
				<div class="fields fields-large">
					<label for="search"><span class="label-text">Tìm từ này:</span> <span class="hide-if-regex-off regex-left">/</span><input id="search" type="text" placeholder="search for&hellip;" value="<?php $this->esc_html_attr( $this->search, true ); ?>" name="search" /><span class="hide-if-regex-off regex-right">/</span></label>
					<label for="replace"><span class="label-text">Thay thế bằng:</span> <input id="replace" type="text" placeholder="replace with&hellip;" value="<?php $this->esc_html_attr( $this->replace, true ); ?>" name="replace" /></label>
			...
			<fieldset class="row row-db">
				...
				<div class="fields fields-small">
					...
					<div class="field field-short">
						<label for="name">Tên database name:</label>
						<input id="name" name="name" type="text" value="<?php $this->esc_html_attr( $this->name, true ); ?>" />
					</div>

					<div class="field field-short">
						<label for="user">Tên đăng nhập database username:</label>
						<input id="user" name="user" type="text" value="<?php $this->esc_html_attr( $this->user, true ); ?>" />
					</div>

					<div class="field field-short" style="display: block;">
						<label for="pass">Mật khẩu password:</label>
						<input id="pass" name="pass" type="text" value="<?php $this->esc_html_attr( $this->pass, true ); ?>" />
					</div>
					
					<div class="field field-short">
						<label for="host">Máy chủ mysql:</label>
						<input id="host" name="host" type="text" value="<?php $this->esc_html_attr( $this->host, true ); ?>" /> (Thông thường là localhost)
					</div>

					<div class="field field-short">
						<label for="port">Cổng mysql port:</label>
						<input id="port" name="port" type="text" value="<?php $this->esc_html_attr( $this->port, true ); ?>" /> (Thông thường là 3306)
					</div>
				...
				<div class="fields">
					...
					<div class="field radio">
						<label for="all_tables">
							...
							Chỉ tìm và thay thế (search and replace) trong tất cả các bảng của database này.
						</label>
					</div>
					...
					<div class="field radio">
						<label for="subset_tables">
							...
							Chỉ tìm và thay thế (search and replace) ở những bảng tôi chọn dưới đây:
						</label>
					</div>
			...
			<fieldset class="row row-results">
				...
				<div class="fields">
					...
					<span class="submit-group">
						<input type="submit" name="submit[update]" value="Cập nhật lại thông tin Mysql" />

						<input type="submit" name="submit[dryrun]" value="Chạy thử" <?php if ( ! $this->db_valid() ) echo 'disabled="disabled"'; ?> class="db-required" />

						<input type="submit" name="submit[liverun]" value="Thực hiện tìm + thay thế" <?php if ( ! $this->db_valid() ) echo 'disabled="disabled"'; ?> class="db-required" style="background:red;"/>
			...
			<section class="row row-delete">
				...
				<div class="fields">
					<p>
						<input type="submit" name="submit[delete]" value="delete me"  style="background:red;"/>
						Sau khi xử lý xong, hãy ấn nút <strong>delete me</strong> để xóa file này đi cho an toàn.
					</p>
				</div>
